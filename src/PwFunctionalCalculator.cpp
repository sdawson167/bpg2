...
double PwFunctionalCalculator::fQuad(fftw_complex* cplxFieldData, double* laplacian, int numFieldElements)
{
  double fQuad = 0.0;
...
void PwFunctionalCalculator::makeGammaArray(double* Gamma, double* laplacian, int N)
{
...
double PwFunctionalCalculator::fQuad(FieldProvider &field)
{
...
double PwFunctionalCalculator::fNL(fftw_complex* realFieldData, int numFieldElements)
{
  double fNL = 0.0;
  for (int index = 0; index < numFieldElements; index++) {
...
double PwFunctionalCalculator::fNL(FieldProvider &field)
{
 ...
 *  ============================================================
 */
void PwFunctionalCalculator::nlDeriv(
 ...
 *  ===========================================================
 */
double PwFunctionalCalculator::fQuadB(FieldProvider &field, double* b)
{
